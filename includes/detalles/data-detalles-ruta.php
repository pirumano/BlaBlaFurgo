<div class="row">
	...
	<div class="col-xs-12 but-contact-detalles">
		<span class="but-contactar js-show-contact" type="ruta" loged=<?php if($login): ?> "loged" <?php else: ?> "no" <?php endif; ?> contact="1">Contactar con usuario</span>
	</div>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6">
        <div class="left-content">
            <span class="container-item">
	            <span class="title">Vehiculo/s:</span>
	            <span class="info info-vehiculos-ruta">
	            	<span><?php echo $vehiculos; ?></span>
	            </span>
            </span>
            <span class="container-item">
	            <span class="title">Descripcion:</span><span class="info"><?php echo $descripcion; ?></span>
            </span>
        </div>
    </div>
    <div class="col-xs-12 col-sm-6">
        <div class="right-content">
            <span class="container-item">
	            <span class="title">Precio minimo:</span><span class="info"><?php echo $presu_min; ?><?php if($presu_min != "No Especificado"): ?>€<?php endif; ?></span>
            </span>
            <span class="container-item">
	            <span class="title">Cargas:</span><span class="info"><?php if($cargas == ""): ?> No Especificado <?php else: ?><?php echo $cargas; ?><?php endif; ?></span>
            </span>
        </div>
    </div>
</div>
